...
class Cita(models.Model):
    ...
    especialidad = models.CharField(max_length=100, blank=True, null=True)  # Especialidad asociada (opcional)
    estado = models.CharField(max_length=20)  # Estado de la cita (ejemplo: pendiente, completada)
...
class Medico(models.Model):
    ...
    correo = models.CharField(unique=True, max_length=100)  # Correo único del médico
